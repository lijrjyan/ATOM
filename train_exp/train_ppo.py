...
This script implements the training process for the PPO (Proximal Policy Optimization) model.
It includes:
- Data loading and preprocessing.
- Model initialization for PPOAgent, FusionGRU, and associated components.
    ...
    for seed_now in seed:
        ...
        for epoch in range(num_epochs):
            ...
            for batch_idx, (batch_seqs, batch_labels) in enumerate(train_loader):
                ...
                agent.update(memory)
                memory.clear()
        #     val_reward, val_accuracy, val_precision, val_recall, val_f1 = validate_model(
        #         agent, gru, mlp_transform, val_loader,
        #         target_model, data, all_embeddings,
        #         hidden_size, action_dim, device
        #     )
