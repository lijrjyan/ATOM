...
- Model initialization for StandardRNN, FusionGRU, and associated components.
...
import numpy as np
from models.RNN import test_model_rnn,custom_reward_function
import os
...
def train_rnn(config):
    ...
    for seed_now in seed:
        ...
        with torch.no_grad():
            ...
            agent_s, rnn_s, mlp_transform_s, test_loader, target_model, data, hidden_size, all_embeddings, action_dim, device
        )
